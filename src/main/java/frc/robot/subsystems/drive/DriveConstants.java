 ...
 *
 * <p>NOTE: PathPlanner loads robot mass/MOI/module config from deploy/pathplanner/settings.json
 * via RobotConfig.fromGUISettings() — that file is a second source of truth alongside
 * TunerConstants (settings.json says max 5.44 m/s vs kSpeedAt12Volts 5.85 m/s, known mismatch).
 */
