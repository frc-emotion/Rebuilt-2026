...
public class TurretAimingCalculator {
    ...
    public TurretAimingCalculator() {
        ...
        flywheelRPSTable.put(1.5501340177286882, 42.5);//45 //42.5);  //  48.5"
        flywheelRPSTable.put(2.47698, 45.0);//47 //45  //  87.25"
        flywheelRPSTable.put(3.5, 50.0); //52 //50  // 127.25"
        flywheelRPSTable.put(4.620237, 57.0);//59 //57 // 165"
