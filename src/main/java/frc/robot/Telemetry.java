...
/**
 * Telemetry class for drivetrain state visualization.
 * 
 * <p>
 * Motor health telemetry (current, voltage, temperature) for subsystem motors
 * is now handled automatically by {@link frc.robot.logging.TalonFXLogger} via
 * Epilogue.
 * 
 * <p>
 * This class focuses on:
 * <ul>
 * <li>Drivetrain state (pose, speeds, module states) to NetworkTables and
 * SignalLogger</li>
 * <li>Field2d pose visualization for AdvantageScope</li>
 * <li>Mechanism2d module state visualization</li>
 * <li>Battery voltage logging</li>
 * </ul>
 */
public class Telemetry {
    ...
    /**
     * Construct a telemetry object for drivetrain state visualization.
     * 
    ...
    /* Misc telemetry */
    private final NetworkTable miscTable = inst.getTable("MiscTelemetry");
    private final DoublePublisher batteryVoltage = miscTable.getDoubleTopic("BatteryVoltage").publish();
