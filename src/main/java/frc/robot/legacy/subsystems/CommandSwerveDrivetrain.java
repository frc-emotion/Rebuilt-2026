...
import frc.robot.legacy.Constants.TunerConstants.TunerSwerveDrivetrain;
 ...
 *
 * <p>
 * The @Logged annotation enables automatic telemetry via Epilogue.
 *
...
public class CommandSwerveDrivetrain extends TunerSwerveDrivetrain implements Subsystem {
    ...
    /* Swerve request for PathPlanner path following */
    ...
    private final SysIdRoutine m_sysIdRoutineTranslation = new SysIdRoutine(
            new SysIdRoutine.Config(
                    ...
                    // No custom state logger — uses WPILib DataLog (WPILOG) by default
            ),
     ...
     * Call this once after the drivetrain is constructed.
     * PID gains (translation 10/0/0, rotation 7/0/0) are starting defaults — tune on carpet.
     */
